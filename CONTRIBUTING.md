...
Update `CHANGELOG.md`, `docs/COMPATIBILITY.md`, and `docs/PRODUCTION_READINESS.md` when preparing a release. Follow `RELEASE_CHECKLIST.md`. A release branch must not be merged when `qacraft release-check` or the pull-request validation job fails.
