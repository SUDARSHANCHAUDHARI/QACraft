...
- [Start from a checkout](#start-from-a-checkout)
- [Build verified artifacts](#build-verified-artifacts)
- [Install into a verified agent](#install-into-a-verified-agent)
- [Verify, update, and uninstall](#verify-update-and-uninstall)
- [Evaluate structured QA reports](#evaluate-structured-qa-reports)
