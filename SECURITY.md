...
- release metadata, rubric-to-skill binding, and lean-CI validation;
...
Use temporary directories, synthetic candidate reports, and local files. The repository test suite and `scripts/demo.py` demonstrate the supported isolated workflow without network, customer, or production access.
